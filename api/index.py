...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "FB732" # Playfab Title Id
        self.SecretKey: str = "JDB6NF4BRPRABJR8U6S73DOK5TIZ4SG5U73P4JYC5I1HJRFITS" # Playfab Secret Key
        self.ApiKey: str = "OC|1111256535410134|6cd68c7b50957d10c195c3508e2a52c3" # App Api Key
